...
import com.dss.sorm.bean.JavaFieldGetSet;
import com.dss.sorm.bean.TableInfo;
import com.dss.sorm.core.DBManager;
import com.dss.sorm.core.MySqlTypeConvertor;
import com.dss.sorm.core.TableContext;
import com.dss.sorm.core.TypeConvertor;
...
public class JavaFileUtils {
	...
	public static JavaFieldGetSet createFieldGetSetSRC(ColumnInfo column,TypeConvertor convertor) {
		...
		//public之前后面少了一个空格，一定要注意！！！！！！
		getSrc.append("\t\treturn "+column.getName()+";\n");
		getSrc.append("\t}\n");
		jfgs.setGetInfo(getSrc.toString());//这个地方出过错setgetinfo写成了setfiledinfo
